...
async function ncatStoped() {
    ...
    try {
        ...
        const elements = await driver.findElements(By.xpath("(//div[@class='MuiBox-root muirtl-8hj6rj'])[3]/div/button"));
        ...
        await driver.findElement(By.xpath("/html/body/div[27]/div[3]/div/div/div/form/div/div[2]/div/div/input")).sendKeys("123");
        await driver.sleep(1000)

        await driver.findElement(By.xpath("/html/body/div[27]/div[3]/div/div/div/form/div/div[3]/div/div/input")).sendKeys("1234567");
        await driver.sleep(1000)
