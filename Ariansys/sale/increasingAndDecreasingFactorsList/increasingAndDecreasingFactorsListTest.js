...
class increasingAndDecreasingFactorsListTest extends BaseArianTechScript {
  constructor() {
    super();
  }
  ...
  async implement(driver, dr) {
    const steps = [
      ...
      "//li[@role='menuitem' and .//span[text()='عوامل کاهنده و افزاینده']]",
    ...
    const editBtn2Xpath =
      "/html/body/div[3]/div/div[2]/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div/table/tbody/tr[1]/td[9]/div/span[1]";
    try {
    ...
    const activeBtnXpath =
      "/html/body/div[3]/div/div[2]/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div/table/tbody/tr[1]/td[9]/div/span[3]";
    ...
    const deleteBtnXpath =
      "/html/body/div[3]/div/div[2]/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div/table/tbody/tr[1]/td[9]/div/span[2]";
...
async function main() {
  let success = false;
  try {
    const test = new increasingAndDecreasingFactorsListTest();
...
module.exports = increasingAndDecreasingFactorsListTest;
