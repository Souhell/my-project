...
async function pricingCircular() {
  ...
  try {
    ...
    await driver
      .findElement(
        By.xpath(
          "/html/body/div[3]/div[1]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/form/div[6]/div/div[1]/label"
        )
      )
      .click();
    // await driver
    ...
    await driver
      .findElement(
        By.xpath(
          "/html/body/div[3]/div[1]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/form/div[6]/div/div[2]/div[1]/button"
        )
      )
      .click();
    await driver.sleep(1000);
    ...
    try {
      ...
      fs.writeFileSync("pricingCircular.png", screenshot, "base64");
      console.log("اسکرین‌شات از خطا در pricingCircular.png ذخیره شد");
...
pricingCircular();
module.exports = pricingCircular;
