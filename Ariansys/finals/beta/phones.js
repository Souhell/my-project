...
async function operatorcreate() {
    ...
    try {
        ...
        await driver.sleep(1000) 
         ...
         await driver.sleep(1000)
         //شروع تور
         await driver.findElement(By.xpath("/html/body/div[6]/div/div[2]/div/div[3]/div[2]/button[2]")).click()
        await driver.sleep(10000)
        await driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div[1]/div[3]/div/div[3]/button")).click()
        await driver.sleep(1000)
        await driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div[1]/div[3]/div/div[3]/div/div[2]/div/div[1]/div/div/div[2]/div[2]/div/div[2]/button")).click()
        await driver.sleep(1000)
        await driver.findElement(By.xpath("/html/body/div[6]/div/div[2]/div/div[3]/div[2]/button[2]")).click()
        await driver.sleep(1000)
        await driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div[1]/div[3]/div/div[4]/button")).click()
        await driver.sleep(1000)
        await driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div[1]/div[3]/div/div[4]/div/div[2]/div/div[1]/div/div/div[2]/div[2]/div/div[2]/button[1]")).click()
        await driver.sleep(1000)
        await driver.findElement(By.xpath("/html/body/div[6]/div/div[2]/div/div[3]/div[2]/button[2]")).click()
        await driver.sleep(1000)
        await driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div[1]/div[3]/div/div[5]/button")).click()
        await driver.sleep(1000)
        await driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div[1]/div[3]/div/div[5]/div/div[2]/div/div[1]/div/div/div[2]/div[2]/div/div[2]/button[1]")).click()
        await driver.sleep(1000)
        await driver.findElement(By.xpath("/html/body/div[6]/div/div[2]/div/div[3]/div[2]/button[2]")).click()
        await driver.sleep(1000)
        const cookiesPath = path.join(__dirname, "cookies.json");
