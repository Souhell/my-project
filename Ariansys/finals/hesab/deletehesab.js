...
async function deletehesab() {
    ...
    try {
        ...
        await driver.sleep(100);
        await driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div[1]/div[2]/div/div[3]/div/ul/li[1]/ul/li[1]/ul/li[5]")).click();
        await driver.sleep(100);
